...
PRODUCT_COPY_FILES += \
    ...
    $(VENDOR_DEVICE_FOLDER)/system/lib/egl/libEGL_adreno.so:system/lib/egl/libEGL_adreno.so \
    $(VENDOR_DEVICE_FOLDER)/system/lib/egl/libGLESv1_CM_adreno.so:system/lib/egl/libGLESv1_CM_adreno.so \
    $(VENDOR_DEVICE_FOLDER)/system/lib/egl/libGLESv2_adreno.so:system/lib/egl/libGLESv2_adreno.so \
    $(VENDOR_DEVICE_FOLDER)/system/lib/egl/libGLESv2S3D_adreno.so:system/lib/egl/libGLESv2S3D_adreno.so \
    $(VENDOR_DEVICE_FOLDER)/system/lib/egl/libq3dtools_adreno.so:system/lib/egl/libq3dtools_adreno.so \
    $(VENDOR_DEVICE_FOLDER)/system/lib/libadreno_utils.so:system/lib/libadreno_utils.so \
    ...
    $(VENDOR_DEVICE_FOLDER)/system/lib/libllvm-arm.so:system/lib/libllvm-arm.so \
    $(VENDOR_DEVICE_FOLDER)/system/lib/libOpenCL.so:system/lib/libOpenCL.so \
